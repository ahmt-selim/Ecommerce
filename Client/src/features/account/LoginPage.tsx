        ...
        <Container maxWidth="xs">
            <Paper sx={{marginTop: 8, padding: 2}} elevation={3}>
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate sx={{mt: 2}}>
                    ...
                    <TextField name="password" value={values.password} onChange={handleInputChange} label="Enter password" type="password" fullWidth required autoFocus sx={{mb:2}} size="small"></TextField>
